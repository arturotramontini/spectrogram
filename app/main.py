...
class App(Window):
    def init(self):
        ...
        # 1/20th second ticks
        self.nodes.append(
            Ticks(self.ctx, x=81, y=660, w=1200, h=15,
                  gap=6, color=(0.3, 0.3, 0.4, 1))
        )
        # 1 second ticks
        self.nodes.append(
            Ticks(
    ...
    def draw(self, dt):
        ...
        logger.info(f"{self.source.hop_cnt}, {
                    self.source.hop_size}, {available}")
